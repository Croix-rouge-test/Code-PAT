...
def traitement_all_data(liste_df_a_fusionner_toutes_structures, liste_df_a_fusionner_DT, df_ref_structure,df_ref_structure_DT,year):
  colonnes_indicateurs = ['n_structure',
    ...
    f"Financier ResCorrProd_{year-1}",
    ...
    f"Dispositifs_d_urgence Nb_formes_PREVIC_{year}", 
    f"Dispositifs_d_urgence Nb_sessions_PREVIC_{year}"
    ...
    "Maraude Nb_contacts",
    "Maraude Nb_personnes_diff_rencontrees",
    ...
    f"Secours Nb_DPS_PE_ps_{year}",
    f"Secours Nb_DPS_ME_ps_{year}",
    f"Secours Nb_DPS_GE_ps_{year}",
    f"Secours Nb_DPS_{year}",
    f"Secours Nb_PAPS_{year}",
    f"Secours Nb_DPS_PE_{year}",
    f"Secours Nb_DPS_ME_{year}",
    f"Secours Nb_DPS_GE_{year}",
    f"Secours Produits_DPS_2025",
