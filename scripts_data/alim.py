...
def indicateurs_alim(df_alim_sans_doublons, df_ref_structure):
  ...
  df_alim_accueil_alimentaire_DT = df_alim_accueil_alimentaire_DT.groupby("DT_de_rattachement").size().reset_index(name="Aide_alimentaire Nb_Centre_distribution_alimentaire DT")
  ...
  df_alim_crsr_DT = df_alim_crsr_DT.groupby("DT_de_rattachement").size().reset_index(name="Aide_alimentaire Nb_crsr DT")
